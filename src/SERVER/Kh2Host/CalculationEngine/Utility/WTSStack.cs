...
{
    public class WTSStack<T> : IEnumerable<T>,IDisposable
    {
        ...
        public void Push(WTSStack<T> Stack)
        {
        ...
        /// <returns></returns>
        public WTSStack<T> PopStack(int PopCount)
        {
            // create a new stack
            WTSStack<T> stack = new WTSStack<T>(PopCount);
    ...
    public class WTSStackEnumerator<T> : IEnumerator<T>
    {
        #region Local Variables
        ...
        public WTSStackEnumerator(System.Collections.Generic.List<T> Items)
        {
            items = Items;
            location = -1;
        }
