...
public class StationDetailInfo
{
    ...
    public class CommandHandler : IRequestHandler<Command, Response>
    {
        ...
        public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                var stations = _context.StationViews.ToList();
                ...
                if(stations.Count > 0)
                {
                    ...
                    foreach (var stn in stations)
                    {
                        ...
                        datas["OfficeId"] = stn.MemberOfficeId;
                        datas["OfficeName"] = stn.OfficeName;
                        datas["StationId"] = stn.StationId;
                        datas["StationName"] = stn.StationName;
                        datas["StationTypeId"] = stn.StationTypeId ?? 0;
                        datas["StationTypeName"] = stn.StationTypeName;
                        datas["ModelId"] = stn.ModelId ?? 0;
                        datas["ModelName"] = stn.ModelName;
                        datas["StationAdder"] = stn.StationAdder?? "";
